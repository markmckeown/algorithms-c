...
CGREEN_LIBS     := -lalgorithms -lcgreen
ifeq "$(OS)" "Linux"
CGREEN_LIBS            += -luuid
...
$(RELEASE_CGREENDIR)/%.exe: $(CGREEN_HOME)/%.c
	$(CC) $(RELEASE_CFLAGS) $(RELEASE_LIBPATH) $(GCREEN_LINK_DIR) -o $@ $< $(CGREEN_LIBS)

$(DEBUG_CGREENDIR)/%.exe: $(CGREEN_HOME)/%.c
	$(CC) $(DEBUG_CFLAGS) $(DEBUG_LIBPATH) $(GCREEN_LINK_DIR) -o $@ $< $(CGREEN_LIBS)

$(COVERAGE_CGREENDIR)/%.exe: $(CGREEN_HOME)/%.c
	$(CC) $(DEBUG_CFLAGS) $(COVERAGE_LIBPATH) $(GCREEN_LINK_DIR) -o $@ $< $(CGREEN_LIBS)
